      ...
      <div class="modal-body">
        <div style="width:90%; font-family:'Roboto', sans-serif; font-weight:400">
          <form style="float:left" name="guardarFechas" method="post" action="convocatorias_abiertas.php">
            <input type="hidden" name="id_conv"value="<?php echo $convocatoria['id'] ?>" />
            <input id="fecha_publicacion" type="hidden" name="fecha_publicacion" value="1" />
           ...
           <div class="input-append date" data-date-format="dd-mm-yyyy"style="float:left; margin-bottom: 15px;" id="fecha_inicio_insc">
            <input class="form-control" type="text" name="fecha_inicio_insc" placeholder="Inicio" value="<?php  $date1 = new DateTime( $convocatoria['fecha_inicio_insc'] );
                        echo $date1->format("d/m/Y"); ?>">
            <span class="add-on"><i class="icon-th"></i></span>
          </div> 
          <div class="input-append date" data-date-format="dd-mm-yyyy"style="float:left; margin-bottom: 10px; margin-left: 10px;" id="fecha_fin_insc">
        ...
        <form name="publicar" method="post" action="../tcpdf/reportes/reporte_transparente.php">
         ...
         <input id="nro_conv" type="hidden" name="nro_conv"value="<?php echo generarIdentificador($organismo[0],$convocatoria['identificador']); ?>" />
         ...
         <input name="motivo" type="hidden" value="<?php echo $convocatoria['motivo'] ?>"/>
          ...
          <?php $date1 = new DateTime( $convocatoria['fecha_inicio_insc'] );
                $date2 = new DateTime($convocatoria['fecha_fin_insc']); 
          ?>
         <input name="fecha_insc" type="hidden"   value="Desde <?php echo $date1->format("d/m/Y"); ?> hasta <?php echo $date2->format("d/m/Y");?>" />
