...
class MYPDF extends TCPDF {
    ...
    public function LoadData() {
        ...
        foreach($registros as $reg) {
			...
			$line = $reg['SECCION'].';'.$reg['APELLIDO']. ', '.$reg['NOMBRE'].';$ '.$monto.';'.$tipo_cobro;				
            $data[] = explode(';', chop($line));
        }
		$line_blanco = ';;;'; 
		$line_total_sin_tarjeta = ''.';'.'TOTAL EN EFECTIVO'.';$ '.$total_sin_tarjeta.';'.'';				
...
// column titles
$header = array('SECCION', 'PASAJERO', 'MONTO COBRADO', 'TIPO DE COBRO');
